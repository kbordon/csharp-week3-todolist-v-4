...
namespace ToDoList.Tests
{
    ...
    public class TaskTests : IDisposable
    {
       ...
       [TestMethod]
        ...
        [TestMethod]
        public void UpdateDescription_UpdatesTaskInDatabase_String()
        {
          //Arrange
          string description = "Walk the Dog";
          DateTime newDateTime = new DateTime(2016,12,31);
          Task testTask = new Task(description, 1, newDateTime, newDateTime.ToString());
          testTask.Save();
        ...
        [TestMethod]
        public void DeleteTask_DeleteATaskInDatabase_List()
        {
            //Arrange
            Category testCategory = new Category("Household chores");
            testCategory.Save();
            ...
            //Act
            secondTask.DeleteTask(secondTask.GetId());
